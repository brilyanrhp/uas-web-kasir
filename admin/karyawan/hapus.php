...
<body>
    ...
    <form action="proses.php" method="post" enctype="multipart/form-data">
        <div class="container pt-4">
            <h1 class="mb-3">Hapus Data Karyawan</h1>
            <hr>
            <div class="row">
                <div class="col-md-6">
                    <h5>Foto saat ini</h5>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" <?php echo "value='" . $data['nama'] . "'" ?> readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="hp" id="hp" <?php echo "value='" . $data['hp'] . "'" ?> readonly>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <input type="text" class="form-control" name="alamat" id="alamat"
                            <?php echo "value='" . $data['alamat'] . "'" ?> readonly>
                    </div>
                    <div class="form-group">
